...
namespace AllArt.Solana.Nftest
{
    [System.Serializable]
    ...
    public class Nftest
    {
        ...
        public Nftest(Metaplex metaplexData)
        {
        ...
        public static async Task<Nft> TryGetNftData(string mint, SolanaRpcClient connection ,bool tryUseLocalContent = true)
        {
            ...
            if (metaplexDataPubKey != null)
            {
                ...
                if (tryUseLocalContent)
                {
                   ...
                   // Debug.Log(tryUseLocalContent + "hhhhhhhhhhhhhhhhhffffffffffffffffffffffffffffffffffffffffffffffffff");
        ...
        internal static Task<Nft> TryGetNftData(string v1, object newtonsoft, bool v2)
        {
